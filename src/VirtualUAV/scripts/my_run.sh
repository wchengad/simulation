...
JOB_PARAMS=${1:-'--idx 0 --ishape 0 --stride 50 --seq_name h36m_S1_Posing'} # defaults to [0, 0, 50]
...
$BLENDER_PATH/blender -b -P main.py

### RUN PART 2  --- Uses python2 because of OpenEXR
PYTHONPATH="" ${PYTHON2_PATH}/bin/python2.7 main_2.py ${JOB_PARAMS}
